        ...
        <Layout>
            <Content style={{ marginTop: "50px" }}>
                ...
                <Row style={{marginTop: "50px"}}>
                    <Col span={6}>
                        <span>Filter:</span>
                        <FacetSider query={props.strQuery} filterObj={props.filterObj} filterTimeSpan={props.filterTimeSpan} filterTaskTypes={props.filterTaskTypes} updateQuery={props.updateQuery} offset={props.offset} searchType={props.searchType} />
                    </Col>
                    <Col span={18}>
