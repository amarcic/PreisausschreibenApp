        ...
        <Layout>
            <Content style={{ marginTop: "50px" }}>
                ...
                <Row style={{marginTop: "50px"}}>
                    <Col span={6}>
                        <span>Filter:</span>
                        <FacetSider query={props.strQuery} filterObj={props.filterObj} filterTaskTypes={props.filterTaskTypes} updateQuery={props.updateQuery} offset={props.offset} searchType={props.searchType} />
                    </Col>
                    <Col span={18}>
                        ...
                        <Table
                            ...
                            pagination={{ total: props.hitsCount, showTotal: total => total + ' Treffer', onChange: (page, pageSize) => props.updateQuery({ strQueryObj: props.strQuery, filterObj: props.filterObj, filterTaskTypes: props.filterTaskTypes, type: props.searchType, offset: (page-1)*pageSize}) }}
                            onHeaderRow={ (column, index) => {return {onClick: event => props.updateQuery({ strQueryObj: props.strQuery, filterObj: props.filterObj, filterTaskTypes: props.filterTaskTypes, type: props.searchType, sort: {on: "esStart", order: "asc"}, offset: props.offset })}} }
