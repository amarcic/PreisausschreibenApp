                ...
                <Col>
                    ...
                    <div style={{ maxWidth: "1680px" }}>
                        <Row gutter={24}>
                            ...
                            <Col span={8}>
                                <Card cover={<img src="http://via.placeholder.com/300x300"/>} hoverable onClick={ () => props.history.push('/overview') } bordered={false}><Meta title="Körperschaftensuche" description="899 Vereine, Institutionen, etc" /></Card>
                            </Col>
                        </Row>
